...
- [x] 1.2 Restringir a ADMIN via `request.checkIfEmployeeIsAdmin()` e validar `id` (cuid) no path
...
- [ ] 2.3 Validar manualmente os fluxos `200`/`400`/`404`/`401` (em manutenção, em uso, não-ADMIN)

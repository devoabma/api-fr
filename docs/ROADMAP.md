...
- [~] Listar todos os funcionários (`get-all.ts` — `GET /employees/get-all`; devolve `createdAt` de cada funcionário e ordena por data de cadastro desc; paginação ainda pendente)
